...
echo "Actions: Packaging QMod with ModID: $ModID and BS-Hook version: $BSHook"
    ...
    Compress-Archive -Path "./libs/arm64-v8a/lib$ModID.so", "./libs/arm64-v8a/libbeatsaber-hook_$BSHook.so", ".\mod.json", ".\cover.png", "./libs/arm64-v8a/libsocket_lib.so" -DestinationPath "./Temp$ModID.zip" -Update
