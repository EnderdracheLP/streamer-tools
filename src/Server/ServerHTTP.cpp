...
void STManager::HandleRequestHTTP(int client_sock) {
    ...
    #define ROUTE(METHOD,URI)    else if ((BufferStr.find(METHOD " " URI " ") != std::string::npos) ||  (BufferStr.find(METHOD " " URI "/ ") != std::string::npos) ||  (BufferStr.find(METHOD " " URI "?") != std::string::npos))
